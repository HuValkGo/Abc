...
namespace Abc.Tests.Pages.Extensions
{
    ...
    public class ConstantsTests:BaseTests
    {
        ...
        [TestMethod] public void ProductTypesPageTitleTest() => Assert.AreEqual("ProductTypes", Constants.ProductTypesPageTitle);
        ...
        [TestMethod] public void SystemOfUnitsPageTitleTest() => Assert.AreEqual("System Of Units", Constants.SystemOfUnitsPageTitle);
        ...
        [TestMethod] public void RatesPageTitleTest() => Assert.AreEqual("Rates", Constants.RatesPageTitle);
